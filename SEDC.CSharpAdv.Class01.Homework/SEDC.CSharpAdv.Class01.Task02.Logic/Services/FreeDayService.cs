...
namespace SEDC.CSharpAdv.Class01.Task02.Logic.Services
{
    public class FreeDayService
    {
        ...
        public bool CheckIfDateIsNonWorkingDay(DateTime date)
        {
            ...
            else if(date.Month == 9 && date.Month == 8)
            {
                return true;
            }
        ...
        {
            return (date.DayOfWeek == DayOfWeek.Saturday || date.DayOfWeek == DayOfWeek.Sunday) || (date.Month == 4 && date.Day == 20) ||
                (date.Month == 5 && (date.Day == 1 || date.Day == 25)) || (date.Month == 8 && date.Day == 3) || (date.Month == 9 && date.Month == 8) ||
                (date.Month == 10 && (date.Day == 12 || date.Day == 23)) || (date.Month == 12 && date.Day == 8);
        }
